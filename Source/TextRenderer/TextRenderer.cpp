...
TextRenderer::TextRenderer(GLuint width, GLuint height)
{
	...
	shader->AddShader("Source/TextRenderer/Shaders/VertexShaderText.glsl", GL_VERTEX_SHADER);
	shader->AddShader("Source/TextRenderer/Shaders/FragmentShaderText.glsl", GL_FRAGMENT_SHADER);
